...
nexttile;
plot(x_grid_hydro./1000,params.rho_w*params.g*gradient(b)./gradient(x_grid_hydro),'.g','LineWidth',1,'MarkerSize',8,'DisplayName','$\rho_wg\frac{\partial b}{\partial x}$');
hold on; 
plot(x_grid_hydro./1000,gradient(params.rho_i*params.g*h_interp*params.h0)./gradient(x_grid_hydro),'.b','LineWidth',1,'MarkerSize',8,'DisplayName','$\rho_ig\frac{\partial h}{\partial x}$')
...
plot(x_grid_ice(2:end)./1000,shear_stress,'LineWidth',1,'MarkerSize',8,'DisplayName', 'Shear');
hold on;
