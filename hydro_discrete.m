% Proof of concept solving hydrology equations using finite differences

% Using new scales to compare with the original nondimensionalization from
% Jonny's thesis
...
params.sigma = linspace(0,10,params.Nx)';%[linspace(params.sigGZ/(params.Nx+0.5),params.sigGZ,params.Nx)]';
...
params.psi = 1*(1-3*exp(-20.*params.sigma));
