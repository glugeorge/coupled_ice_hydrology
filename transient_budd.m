...
params.Nh = 1200;
params.sigGZ = 0.8;                %extent of coarse grid (where GL is at sigma=1) - 0.97
...
params.end_year = 5000; % either 5 or 5000 years
...
flf = @(QNShuxg) budd_schoofbed_transient(QNShuxg,params);
...
fname = 'budd_retreat_5000yr_highres.mat';
