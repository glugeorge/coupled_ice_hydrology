end_year = 0.001002003004005;
end_buttressing = 0.400060120180240;
...
params.end_year = end_year; %normally 7500
...
params.S_old = S;
params.transient = 1;
C_fs = linspace(0.4,end_buttressing,params.Nt);
...
fname = 'C_retreat_dt=0.000001yr_long.mat';
