...
params.Nh = 3000;
params.sigGZ = 0.1;                %extent of coarse grid (where GL is at sigma=1) - 0.97
...
params.xg = 200e3./params.x0;
hf = (-bed_flat(params.xg.*params.x0,params)/params.h0)/params.r;
params.h =  1.4.*sqrt(1-params.sigma_elem)+hf; %ones(params.Nx,1).*1000./params.h0;
...
params.u = 1e-6.*ones(params.Nx,1)/params.u0;
...
%% Initial condition
Q = ones(params.Nh,1)./params.Q0;
N = ones(params.Nh,1);
S = 5/params.S0*ones(params.Nh,1); 
params.S_old = S;
params.M = 1.3093e-4/params.M0; % zero when using schoof bed
params.N_terminus = 0;
